				...
				$window.load(function() {
					...
					skel.onStateChange(function() {
						...
						window.setTimeout(function() {
							...
							//		fi.each(function() { jQuery(this).children('img').css('margin-right', 'auto').css('margin-left', 'auto'); });
							//		fi.each(function() { var img = jQuery(this).children('img'); img/*.css('left', '0%')*/.css('margin-left', /*-1 * (img.width() / 2)// */ '10%' )/*.css('margin-right', 'auto')*/; });
